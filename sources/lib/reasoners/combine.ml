...
module Rel1 : Sig_rel.RELATION
  with type r = CX.r and type uf = Uf.t =
  IntervalCalculus.Relation (CX)(Uf)
    (struct
      include TX1
...
module Rel2 : Sig_rel.RELATION
  with type r = CX.r and type uf = Uf.t =
  Records_rel.Relation
    (struct
      include CX
...
module Relation : Sig_rel.RELATION
  with type r = CX.r and type uf = Uf.t = struct
