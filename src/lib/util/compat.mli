...
module Seq : sig
  ...
  (** [is_empty xs] determines whether the sequence [xs] is empty.
      ...
      ephemeral, it may be the case that [xs] cannot be used any more after this
...
module Type : sig
  ...
  module Id : sig
    ...
    (** [provably_equal i0 i1] is [Some Equal] if identifier [i0] is equal to
        [i1] and [None] otherwise. *)
  end
end
