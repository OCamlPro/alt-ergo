...
module Rel6 : Sig_rel.RELATION = Fpa_rel
...
let query env uf a =
  ...
  try_query (module Rel6) env.r6 uf a @@ fun () -> Th_util.Unknown
...
let optimizing_objective env uf o =
  ...
  optimizing_dispatcher o
    [ Rel1.optimizing_objective env.r1 uf;
      ...
      Rel6.optimizing_objective env.r6 uf ]
...
let instantiate ~do_syntactic_matching t_match env uf selector =
  ...
  in
  let r6, l6 =
    Rel6.instantiate ~do_syntactic_matching t_match env.r6 uf selector
  in
