...
let set_options r =
  ...
  Options.set_infer_input_format (get_input_format r.input_format |> Option.is_none);
  ...
  Options.set_infer_output_format (get_input_format r.output_format |> Option.is_none);
